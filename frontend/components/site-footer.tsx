    ...
    <footer className="mt-24 border-t border-border">
      <div className="mx-auto grid max-w-[1400px] grid-cols-1 gap-6 px-5 py-8 sm:grid-cols-2 lg:grid-cols-4 lg:px-10">
        ...
        <div className="flex flex-col gap-2">
          ...
          <span className="font-mono text-[12px] text-foreground-secondary">{HOST_INFO.host}</span>
        ...
        <div className="flex flex-col gap-2">
          ...
          <span className="font-mono text-[12px] text-foreground-secondary">{HOST_INFO.model}</span>
