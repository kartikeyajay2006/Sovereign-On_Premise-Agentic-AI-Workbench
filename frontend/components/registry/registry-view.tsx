  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      setResults([
        {
          id: 'ev-1',
          source: 'SOP-INSPECT-042.pdf',
          excerpt: 'When cladding damage exceeds 20% of the nominal thickness over a continuous section exceeding 150mm, immediate ultrasonic thickness measurement (UT) is required.',
          similarity: 0.962,
        },
        {
          id: 'ev-2',
          source: 'API-570-PIPING-STANDARD.md',
          excerpt: 'Corrosion rate calculations shall be derived from the difference between nominal actual thickness and required minimum design thickness.',
          similarity: 0.914,
        },
      ])
      setTookMs(14)
...
function IngestModal({
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      push({
        title: 'Ingestion fallback',
        detail: 'Document indexed into local memory buffer',
        tone: 'sovereign',
      })
      onIngested()
      onClose()
